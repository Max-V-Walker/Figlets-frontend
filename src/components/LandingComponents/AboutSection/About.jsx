  ...
  return (
    <section className={styles["about-container"]}>
      <div className={styles["about-information"]}>
        ...
        <p>
          We're a fully licensed and insured construction company with over 15
          years of experience delivering high-quality work to New Jersey.
          <span className={styles.spacer}></span>From kitchen and bathroom
          renovations to much more, we bring craftsmanship and integrity to
          every project.
        </p>
