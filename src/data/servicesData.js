    ...
    projects: [
      {
        ...
        description:
          "Thinking about redoing your stairs? It’s one of the most overlooked upgrades — but one of the most impactful.",
        time: "June '25",
        location: "NJ",
        images: [
      ...
      },
      {
        ...
        description:
          "Another clean egress window install ✅ We handled the excavation, drainage, and install from start to finish, providing safety, code compliance, and a ton of natural light for the basement. 👷‍♂️🔨",
        time: "June '25",
        location: "NJ",
        images: [
      ...
      },
      {
        ...
        description:
          "Here’s a quick little update, removed popcorn ceiling, added lights, and flooring.",
        time: "November '23",
        location: "NJ",
        images: [
      ...
      },
      {
        ...
        description:
          "Added a door to outside, small deck, and concrete landing at bottom of the steps",
        time: "February '23",
        location: "NJ",
        images: [
      ...
      },
      {
        ...
        description:
          "We transformed this beautiful size attic into a comfortable living/hanging space.",
        time: "November '21",
        location: "NJ",
        images: [
    ...
    projects: [
      {
        ...
        description:
          "We removed a load bearing wall and installed a flush mount beam to not have a visible header. Moved the patio door over as well and everything from the floor to the ceiling.",
        time: "May '25",
        location: "NJ",
        images: [
      ...
      },
      {
        ...
        description:
          "We opened up the space by removing the wall and old kitchen. Added new insulation, lighting, and outlets. Installed a dishwasher, custom cabinets with crown molding, and brand-new floors.",
        time: "November '24",
      ...
      },
      {
        ...
        description:
          "Some before and afters of refinishing kitchen cabinets, sanded down and stained, and tiled new backsplash.",
        time: "November '23",
        location: "NJ",
        images: [
    ...
    projects: [
      {
        ...
        description:
          "Turning 1 bathroom into two full baths. Family bathroom and master bath added.",
        time: "May '25",
        location: "Sayreville, NJ",
        images: [
